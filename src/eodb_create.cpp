...
typedef osmium::index::map::Map<osmium::unsigned_object_id_type, osmium::Location> location_index_type;
    ...
    REGISTER_MAP(osmium::unsigned_object_id_type, size_t, osmium::index::map::DenseMemArray, dense_mem_array);
#endif

#ifdef OSMIUM_HAS_INDEX_MAP_DENSE_MMAP_ARRAY
    REGISTER_MAP(osmium::unsigned_object_id_type, size_t, osmium::index::map::DenseMmapArray, dense_mmap_array);
#endif
